...
import com.accuride.utility.BrowserFactory;

public class BuyProductIfUserIsLoggedIn {
	...
	{
		LogIn loginToTheWebSite = PageFactory.initElements(driver, LogIn.class);
		loginToTheWebSite.validLogin();
	}
	...
	public void checkingUserLoggedInOrNot() throws InterruptedException
	{
		ShoppingAddressPage enterShippingAddresses = PageFactory.initElements(driver, ShoppingAddressPage.class);
		enterShippingAddresses.checkedUserLoggedInOrNot();
	}
	
	@Test(priority=12,enabled=true)
	public void loggedInUserGoingToThePaymentPage() throws InterruptedException
	{
