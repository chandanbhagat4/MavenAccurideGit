...
public class BuyProductFromGuestUser {
...
WebDriver driver;
	...
	{
		ShoppingAddressPage createAccount = PageFactory.initElements(driver, ShoppingAddressPage.class);
		createAccount.enterTheDetails();
	}
